...
const stripe = require("stripe")(
  "sk_test_51M8F0qBHLFdDB22d2MRw1pCwdAqq2vrBxMYpWOb8i2EGZgclmAbExSO4wwxHPshTyW9GAeC0IWcDP7drI3EoKRMo00qmJRzl6j"
);
  ...
  try {
    ...
    const varifyToken = (req, res, next) => {
      ...
      if (!req.headers.authorization) {
        return res.status(401).send({ message: "unauthorired access" });
      }
...
app.listen(port, () => {
  console.log(`Bistro Boss server is runnnig on port ${port}`);
});
